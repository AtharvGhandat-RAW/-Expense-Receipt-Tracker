...
// -------------------------------------------------------
// Shows 4 tabs: Home, Subscriptions, Analytics, Settings.
...
function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 h-16 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 flex items-center justify-around px-2 shadow-[0_-1px_3px_rgba(0,0,0,0.05)]">
      {tabs.map((tab) => {
